class ProfilesController < ApplicationController
    ...
    def new
        ...
        @profile = @user.build_profile    #build_profile can be used cause we established a connection in the routes file (nested resources) we used it here to build a blank profile
    end
